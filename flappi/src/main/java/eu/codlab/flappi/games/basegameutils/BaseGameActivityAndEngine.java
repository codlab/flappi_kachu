...
package eu.codlab.flappi.games.basegameutils;
 ...
 */
public abstract class BaseGameActivityAndEngine extends LayoutGameActivity implements
    ...
    protected BaseGameActivityAndEngine() {
        super();
     ...
     */
    protected BaseGameActivityAndEngine(int requestedClients) {
        super();
